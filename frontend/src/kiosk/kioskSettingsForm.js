...
export function kioskSettingsFormFromApi(settings) {
  ...
  return {
    ...
    confirmation_vibration_enabled: Boolean(settings.confirmation_vibration_enabled),
...
export function normalizeKioskSettingsComparable(form, { changingExitCode, exitCodeConfigured }) {
  ...
  return {
    ...
    confirmation_sound_enabled: form.confirmation_sound_enabled !== false,
    confirmation_vibration_enabled: Boolean(form.confirmation_vibration_enabled),
