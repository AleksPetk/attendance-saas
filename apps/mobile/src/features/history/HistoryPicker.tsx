...
function PickerSheet({ title, options, value, searchable, onClose, onChange, t }: {
  ...
  return <Modal animationType="slide" onRequestClose={onClose} transparent visible>
    ...
    <View style={[styles.sheet, { paddingBottom: insets.bottom + space.lg, paddingLeft: insets.left + space.lg, paddingRight: insets.right + space.lg }]}>
...
const styles = StyleSheet.create({
  ...
  scrim: { ...StyleSheet.absoluteFill, backgroundColor: "rgba(7,20,38,0.45)" }, sheet: { position: "absolute", left: 0, right: 0, bottom: 0, maxHeight: "82%", borderTopLeftRadius: radii.lg, borderTopRightRadius: radii.lg, backgroundColor: colors.surface, ...shadows.md }, sheetHandle: { alignSelf: "center", width: 42, height: 4, marginTop: space.sm, marginBottom: space.md, borderRadius: 2, backgroundColor: colors.borderStrong }, sheetHeader: { minHeight: touch.min, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: space.md }, sheetTitle: { ...type.headline, color: colors.text }, monthTitle: { ...type.caption, color: colors.textMuted, marginTop: 2 },
  ...
  monthNav: { flexDirection: "row", justifyContent: "space-between", marginVertical: space.sm }, monthButton: { width: touch.min, height: touch.min, alignItems: "center", justifyContent: "center", borderRadius: radii.sm, backgroundColor: colors.blueSoft }, weekRow: { flexDirection: "row" }, weekday: { width: `${100 / 7}%`, textAlign: "center", ...type.captionStrong, color: colors.textMuted, paddingVertical: space.sm }, calendarGrid: { flexDirection: "row", flexWrap: "wrap" }, day: { width: `${100 / 7}%`, height: 44, alignItems: "center", justifyContent: "center", borderRadius: 999 }, dayActive: { backgroundColor: colors.blue }, dayText: { ...type.body, color: colors.text }, dayOutside: { color: colors.placeholder }, dayTextActive: { color: colors.surface, fontWeight: "700" }, todayButton: { minHeight: touch.min, alignItems: "center", justifyContent: "center", marginTop: space.md, borderRadius: radii.sm, backgroundColor: colors.blueSoft }, todayText: { ...type.label, color: colors.bluePressed },
});
