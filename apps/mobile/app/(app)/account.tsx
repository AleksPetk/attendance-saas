...
type Account = { email?: string; email_verified?: boolean; backup_email_status?: string; backup_email?: string | null; pending_backup_email?: string | null; two_factor_status?: string; preferred_language?: "en" | "ja"; sign_in_methods?: { password?: { enabled?: boolean }; google?: { linked?: boolean }; apple?: { linked?: boolean } } };
...
const styles = StyleSheet.create({ screen: { padding: 0 }, content: { padding: space.lg, paddingBottom: space.xxxl, gap: space.lg }, detail: { minHeight: 54, flexDirection: "row", alignItems: "center", gap: space.sm }, copy: { flex: 1 }, label: { ...type.caption, color: colors.textMuted }, value: { ...type.bodyStrong, color: colors.text }, actions: { gap: space.sm } });
