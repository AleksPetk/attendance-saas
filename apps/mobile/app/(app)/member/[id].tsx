...
const styles = StyleSheet.create({ screen: { padding: 0 }, content: { padding: space.lg, paddingBottom: space.xxxl, gap: space.lg }, hero: { flexDirection: "row", alignItems: "center", gap: space.lg }, heroCopy: { flex: 1, alignItems: "flex-start", gap: space.sm }, info: { minHeight: 52, justifyContent: "center", borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.border }, label: { ...type.caption, color: colors.textMuted }, value: { ...type.bodyStrong, color: colors.text } });
